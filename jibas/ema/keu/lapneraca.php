...
function change_sel() {
	//parent.content.location.href = "lapneraca_blank.php";
}
...
function change_dep() {
	...
	var addr = "lapneraca.php?idtahunbuku="+idtahunbuku+"&tgl1="+tgl1+"&bln1="+bln1+"&thn1="+thn1+"&tgl2="+tgl2+"&bln2="+bln2+"&thn2="+thn2+"&departemen="+dep;
...
function show_laporan() 
{
	...
	if (validasi)
		sendRequestText('get_lapneraca.php',showLap,'departemen='+dep+'&tanggal1='+tanggal1+'&tanggal2='+tanggal2+'&idtahunbuku='+idtahunbuku+'&bln='+bln2+'&thn='+thn2);
	//parent.content.location.href ="laprugilaba_content.php?departemen="+dep+"&tanggal1="+tanggal1+"&tanggal2="+tanggal2+"&idtahunbuku="+idtahunbuku;
		//document.location.href ="lapneraca.php?departemen="+dep+"&tanggal1="+tanggal1+"&tanggal2="+tanggal2+"&idtahunbuku="+idtahunbuku+"&bln="+bln2+"&thn="+thn2;
}
...
function cetak(){
	...
	var tanggal1 = escape(thn1 + "-" + bln1 + "-" + tgl1);
	var tanggal2 = escape(thn2 + "-" + bln2 + "-" + tgl2);
	var addr = 'lapneraca_cetak.php?departemen='+dep+'&tanggal1='+tanggal1+'&tanggal2='+tanggal2+'&idtahunbuku='+idtahunbuku+'&bln='+bln2+'&thn='+thn2;
...
<?		if ($tgl1 == 0)	$tgl1 = $tgl2;
    ...
    <td rowspan="2" valign="middle">
        <a href="#" onclick="show_laporan()"><img src="../img/view.png" border="0" height="48" width="48" id="tabel" onmouseover="showhint('Klik untuk menampilkan data laporan neraca!', this, event, '180px')" /></a>    </td>
    <td width="30%" align="right" valign="top">
    <font size="4" face="Verdana, Arial, Helvetica, sans-serif" style="background-color:#ffcc66">&nbsp;</font>&nbsp;<span class="news_title2">Laporan Neraca</span>
    </td>
</tr>
</table>
</form>
