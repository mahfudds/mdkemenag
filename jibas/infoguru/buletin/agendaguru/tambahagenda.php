...
if (isset($_REQUEST['simpan']))
{
	...
	$sql="INSERT INTO jbsvcr.agenda
			SET tanggal='$tanggal', judul='$judul',komentar='$komentar',idguru='$idguru',nis=NULL";
	$result=QueryDb($sql);
	CloseDb();
	if ($result)
	{ ?>
...
<title>Tambah Agenda Guru</title>
...
<body onLoad="document.getElementById('judul').focus();" leftmargin="0" topmargin="0" style="background-image:url(../../images/bgpop.jpg); background-repeat:repeat-x">
<form name="agenda" id="agenda" action="tambahagenda.php" method="POST" onSubmit="return validate()">
<table width="100%" border="0" cellspacing="5" cellpadding="2" >
  <tr>
    <td colspan="2" scope="row" align="left"><span class="style1"><font size="2">Agenda Baru :</font></span><br />
      <br /></td>
  </tr>
  <tr>
