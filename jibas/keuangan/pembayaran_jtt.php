...
<tr>
    ...
    <tr>
    	<td valign="top" width="325">
            ...
            <tr>
            	<td colspan="2"><textarea id="keterangan" name="keterangan" rows="2" cols="40" onKeyPress="return focusNext('simpan', event)" <? //$dis?> onfocus="panggil('keterangan')" style="width:275px; height:30px"><?=$keterangan ?></textarea>
            	</td>
            </tr>
<?			   if ($idbesarjtt > 0) { ?>
				<tr>
            ...
            <tr>
            	<td colspan="2"><textarea id="alasan" name="alasan" rows="2" cols="40" onKeyPress="return focusNext('simpan', event)" <? //$dis?> onfocus="panggil('simpan')" style="width:275px; height:30px"><?=$alasan ?></textarea>
            	</td>
            </tr>
<?			   } ?>            
           	<tr>
