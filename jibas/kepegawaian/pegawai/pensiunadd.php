...
if (isset($_REQUEST['btSubmit'])) {
	OpenDb();
	$sql = "INSERT INTO jadwal SET nip='$nip', jenis='pensiun', tanggal='$tmt', keterangan='$keterangan', aktif=1";
	QueryDb($sql);
	CloseDb(); ?>
...
function validate()
{
	return validateEmptyText('txThnPensiun', 'Tanggal Pensiun Pegawai') && 
  		   validateInteger('txThnPensiun', 'Bulan Pensiun Pegawai') && 
		   validateLength('txThnPensiun', 'Tahun Pensiun Pegawai', 4) &&
		   validateEmptyText('txKeterangan', 'Keterangan Pensiun Pegawai');
}
...
<tr height="30">
	<td width="100%" class="header" align="center">Jadwal Pensiun</td>
</tr>
<tr>
	...
	<tr>
        <td align="right" valign="top"><strong>Pensiun TMT :</strong></td>
