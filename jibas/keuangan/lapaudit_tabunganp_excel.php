...
header('Content-Disposition: attachment; filename=Laporan_Audit_Tabungan_Pegawai.xls');
header('Expires: 0');  
...
<title>JIBAS KEU [Laporan Audit Perubahan Data Tabungan Pegawai]</title>
</head>

<body>
<center><font size="4" face="Verdana"><strong>LAPORAN AUDIT PERUBAHAN DATA TABUNGAN PEGAWAI</strong></font><br />
</center>
<br /><br />
