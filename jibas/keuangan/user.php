...
function ganti(id) {
	newWindow('user_ganti.php?replid='+id,'GantiPasswordUser','500','220','resizable=1,scrollbars=1,status=0,toolbar=0')
}

function cetak() {
	var total=document.getElementById("total").value;
	var addr = "user_cetak.php?urut=<?=$urut?>&urutan=<?=$urutan?>&varbaris=<?=$varbaris?>&page=<?=$page?>&total="+total;
	newWindow(addr, 'CetakPengguna','790','650','resizable=1,scrollbars=1,status=0,toolbar=0');
}
...
<tr><td align="center" valign="top" background="images/user_trans.png" style="margin:0;padding:0;background-repeat:no-repeat;">
<table border="0" width="100%" align="center">
<!-- TABLE CENTER -->
<tr>
