...
<title>JIBAS SIMAKA [Pengantar Surat]</title>
...
<script language="javascript" src="pengantar.editor.js"></script>
</head>
...
<tr><td align="center" valign="top" background="../images/ico/b_daftarmutasi.png" style="margin:0;padding:0;background-repeat:no-repeat;">
    ...
    <form name="main" method="post" action="pengantar.editor.save.php" onSubmit="return validate()">
    ...
    <tr>
        ...
        <td align="left">
            <input type="text"  class='inputbox' name="departemen" id="departemen" size="10" maxlength="15"
                   value="<?= $departemen ?>" readonly  class="disabled" style="background-color: #ddd"/>
        </td>
		<td rowspan='3' align='right' valign='top'>
			<font style='font-size: 20px; color: #666'><?=$title?> Pengantar Surat</font><br>
			...
			<font size="1" face="Verdana" color="#000000"><b>Pengantar Surat</b></font>
			</a>&nbsp>&nbsp
			<font size="1" face="Verdana" color="#000000"><b><?=$title?> Pengantar Surat</b></font>
		</td>
    </tr>
    <tr>
        <td align="right"><strong>Judul&nbsp;:</strong></td>
        <td align="left">
            <input type="text" class='inputbox' name="judul" id="judul" value="<?=$judul?>" size="70" maxlength="255"/>
        </td>
    </tr>
    <tr>
    	<td align="left"><strong>Pengantar Surat:</strong></td>
    	<td>
            &nbsp;
        </td>
    </tr>
