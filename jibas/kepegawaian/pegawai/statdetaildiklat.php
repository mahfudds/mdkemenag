...
function cetak() {
	var addr = "statdetail_cetak.php?stat=5&status=<?=$status?>&satker=<?=$satker?>";
...
<table width="100%" border="0">
  <tr>
    <td><strong>Eselon : <?=$eselon?></strong><br />
<strong>Status Diklat: <? if ($status == "S") echo "Sudah"; else echo "Belum"; ?></strong>
</td>
