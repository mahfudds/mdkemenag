...
function ShowCbBulanTahun()
{
    ...
    echo "<select id='bulan' name='bulan' onchange='clearReport()'>";
    for($i = 1; $i <= 12; $i++)
    {
    ...
    echo "<select id='tahun' name='tahun' onchange='clearReport()'>";
...
function ShowClientTransReport($showMenu)
{
