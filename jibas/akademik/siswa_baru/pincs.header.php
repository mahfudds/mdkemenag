...
function change_dep()
{
	...
	parent.header.location.href = "pincs.header.php?departemen="+departemen;
	parent.footer.location.href = "pincs.blank.php";
}
...
function change_proses() {
	...
	parent.header.location.href = "pincs.headerphp?departemen="+departemen+"&proses="+proses;
	parent.footer.location.href = "pincs.blank.php";
}
...
function show_calon() {	
	...
	parent.footer.location.href = "pincs.content.php?departemen="+departemen+"&idproses="+proses+"&idkelompok="+kelompok;
}
...
<tr>
    ...
    <tr>
        ...
        <select name="departemen" id="departemen" onchange="change_dep()"
				style="width:280px" onKeyPress="return focusNext('kelompok', event)" onfocus="panggil('departemen')">
...
<?			}	?>
	...
	<td width="*" rowspan="2" valign="middle">
            <a href="#" onclick="show_calon();">
            <img src="../images/view.png" name="tabel" width="48" height="48" border="0"
                 id="tabel" onmouseover="showhint('Klik untuk menampilkan data calon siswa!', this, event, '120px')"/>
            </a>
      </td>
    <td width="45%" colspan = "2" align="right" valign="top">
    <font size="4" face="Verdana, Arial, Helvetica, sans-serif" style="background-color:#ffcc66">&nbsp;</font>&nbsp;<font size="4" face="Verdana, Arial, Helvetica, sans-serif" color="Gray">PIN Calon Siswa</font><br />
    <a href="../siswa_baru.php" target="content">
        <font size="1" color="#000000"><b>PIN Calon Siswa</b></font></a>&nbsp>&nbsp
