...
<table width="100%" border="0" cellspacing="5">
  ...
  <tr>
    <td width="50%">
      ...
      &nbsp;<img src="../img/ico/calendar.png" name="btnawal" id="btnawal" title="Klik untuk membuka kalendar!" onClick="showCal('CalendarISCATPHAR1')"/>
      &nbsp;s.d.&nbsp;
      ...
      &nbsp;<img src="../img/ico/calendar.png" id="btnakhir" onClick="showCal('CalendarISCATPHAR2')" title="Klik untuk membuka kalendar!"/></td>
    <td width="50%"><img title="Klik untuk menampilkan Presensi Harian" style="cursor:pointer;" src="../img/view.png" width="32" height="32" onclick="ShowCatatanHarian()" /></td>
  </tr>
  <tr>
