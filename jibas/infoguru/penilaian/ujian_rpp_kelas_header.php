...
<tr>
    ...
    <td align="left" valign="middle" width="*" rowspan="2">
        <img src="../images/ico/view.png" width="48" height="48" border="0" onClick="show()" id="tabel" style="cursor:pointer;" OnMouseOver="showhint('Klik untuk menampilkan rata-rata ujian kelas!', this, event, '150px')">            </td>
     <td align="right" valign="top" width="374" rowspan="2">
        ...
        <a href="../penilaian.php" target="framecenter"> <font size="1" color="#000000"><b>Penilaian</b></font></a>&nbsp>&nbsp <font size="1" color="#000000"><b>Rata-rata RPP Setiap Kelas</b></font>
  	</td>
</tr>	
</table>
</form>
