...
function tampil() {
	...
	newWindow('presensi_lihat_header.php?departemen='+departemen+'&kelas='+kelas+'&tanggal='+tanggal+'&tingkat='+tingkat, 'LihatPresensiPelajaran','643','342','resizable=1,scrollbars=1,status=0,toolbar=0')
