...
<tr>
	...
	<td width="*" rowspan="4" align="left" valign="middle"><a href="#" onclick="tampil()" ><img src="../images/ico/view.png" onmouseover="showhint('Klik untuk menampilkan laporan harian data siswa yang tidak hadir!', this, event, '100px')" height="48" width="48" border="0" name="tabel" id="tabel2"/></a></td>
