...
require_once('pilihandata.edit.func.php');
...
<head>
    ...
    <title>JIBAS SIMAWAI [Ubah Pilihan Data]</title>
...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0"  style="background-color:#fff" <?=$input_awal?>>
    ...
    <table border="0" width="95%" cellpadding="2" cellspacing="2" align="center">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="hidden" name="idpilihan" id="idpilihan" value="<?=$idpilihan?>">
                <input type="text" name="pilihan" id="pilihan" size="40" maxlength="100" value="<?=$pilihan?>"
                       onFocus="showhint('Nama pilihan tidak boleh lebih dari 100 karakter!', this, event, '120px'); panggil('Simpan')"
