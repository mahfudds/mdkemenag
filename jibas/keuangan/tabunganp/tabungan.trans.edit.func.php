...
{
    global $idpembayaran;
    global $nip, $namapegawai, $idjurnal, $tanggal, $keterangan, $idtabungan, $namatabungan;
    global $debet, $kredit, $rekkas, $rekutang, $action, $jbayar, $rekkastrans;
    
    // -- ambil data-data pembayaran ---------------------------------
    $sql = "SELECT pg.nip, pg.nama, p.idjurnal, p.debet, p.kredit, DATE_FORMAT(p.tanggal, '%d-%m-%Y') AS tanggal, 
                   p.keterangan, pn.nama as namatabungan, pn.rekkas, pn.rekutang, pn.replid AS idtabungan
              FROM tabunganp p, jbssdm.pegawai pg, datatabunganp pn 
