...
{
	$id = $_REQUEST['id'];
	$sql = "DELETE FROM jbsumum.lampiransurat
			 WHERE replid = $id";
	QueryDb($sql);		 
}
...
<tr height="300">
    ...
    <tr>
        <td align="right">
            <font size="4" face="Verdana, Arial, Helvetica, sans-serif" style="background-color:#ffcc66">&nbsp;</font>&nbsp;<font size="4" face="Verdana, Arial, Helvetica, sans-serif" color="Gray">Lampiran Surat</font>
        </td>
    </tr>
    <tr>
        <td align="right"><a href="../pelaporanmenu.php" target="content">
            <font size="1" face="Verdana" color="#000000"><b>Pelaporan</b></font></a>&nbsp>&nbsp <font size="1" face="Verdana" color="#000000"><b>Lampiran Surat</b></font>
        </td>
    </tr>
    <tr>
        <td align="left">&nbsp;</td>
	...
	<tr>
		...
		<td align="left" width='*' colspan="2">
			...
			<tr height='30'>
				...
				<td class='header' width='750'>Judul/Lampiran Surat</td>
