...
<ul id="tmenu0" style="display:none;">
	...
	if ($nsubdir == 0) {
		?><li><a href="sample_link.html"><?=$dir[5]?></a></li><?
	} else {
		?><li><a href="sample_link.html"><?=$dir[5]?></a></li><?
		traverse($iddir, 2);
		echo  "  </ul></li>\r\n";
