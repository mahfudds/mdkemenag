...
{
	OpenDb();
	$sql = "INSERT INTO jadwal SET nip='$nip', jenis='jabatan', tanggal='$tmt', keterangan='$keterangan', aktif=1";
	QueryDb($sql);
	CloseDb(); ?>
...
<title>Jadwal Kenaikan Jabatan</title>
...
<tr height="30">
	<td width="100%" class="header" align="center">Jadwal Kenaikan Jabatan</td>
</tr>
<tr>
