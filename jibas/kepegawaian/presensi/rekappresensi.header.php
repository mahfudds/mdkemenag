...
changeDate = function()
{
    ...
    document.location.href = "rekappresensi.header.php?tahun30="+tahun30+"&bulan30="+bulan30+"&tanggal30="+tanggal30+"&tahun="+tahun+"&bulan="+bulan+"&tanggal="+tanggal;
...
showPresence = function()
{
    ...
    parent.content.location.href = "rekappresensi.content.php?tahun30="+tahun30+"&bulan30="+bulan30+"&tanggal30="+tanggal30+"&tahun="+tahun+"&bulan="+bulan+"&tanggal="+tanggal;
}
</script>
</head>
...
<tr>
	...
	<td align="right" width="50%">
        ...
        <font class="subtitle">Rekapitulasi Presensi Pegawai</font><br>
        <a href="presensi.php" target="_parent">Presensi</a> &gt; Rekapitulasi Presensi Pegawai
