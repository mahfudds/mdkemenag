...
<tr>
    ...
    <td width="26%" rowspan="2" align="center">
		<div id="fotoInfo">
		<img src="../include/gambar.php?nip=<?=$DP->nip?>&table=jbssdm.pegawai&field=foto" height="120">
		</div>
	</td>
</tr>
<tr>
...
<tr>
    ...
    <td width="*" align="left" valign="top">
		<input type="text" name="txNIP" id="txNIP" size="20" maxlength="30" readonly="readonly" style="background-color:#CCC" value="<?=$DP->nip?>" onKeyPress="return focusNext('txNUPTK', event)"/>
	</td>
</tr>
<tr>
