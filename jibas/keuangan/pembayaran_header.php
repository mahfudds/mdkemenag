...
function change_kate() {
	...
	document.location.href = "pembayaran_header.php?idkategori="+idkategori+"&departemen="+departemen;
...
function show_pembayaran() {
	...
	if (idkategori == "LNN") {
		parent.contentblank.location.href = "pembayaran_lainnya.php?idkategori="+idkategori+"&idpenerimaan="+idpenerimaan+"&idtahunbuku="+idtahunbuku+"&departemen="+departemen;	
	} else {
		parent.contentblank.location.href = "pembayaran_main2.php?idkategori="+idkategori+"&idpenerimaan="+idpenerimaan+"&idtahunbuku="+idtahunbuku+"&departemen="+departemen;
	}
}
...
<tr>
    ...
    <tr>
		...
		?>
        <input type="text" name="tahunbuku" id="tahunbuku" size="30" readonly style="background-color:#CCCC99" value="<?=$row['tahunbuku'] ?>">
        <input type="hidden" name="idtahunbuku" id="idtahunbuku" value="<?=$row['id'] ?>" />
    	</td>
	</tr>
    <tr>
