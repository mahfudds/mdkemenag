...
<table width="100%" border="0" cellspacing="0">
  <tr>
    <td scope="row" align="left"><strong><font size="2" color="#999999">Rubrik Baru :</font></strong><br />
      <br /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="2"><input type="text" name="judul" id="judul" maxlength="254" size="50" /></td>
  </tr>
  <tr>
    <th scope="row">Tanggal</th>
    <td colspan="2">
        <input title="Klik untuk membuka kalender !" type="text" name="tanggal" id="tanggal" size="25" readonly="readonly" class="disabled" value="<?=date('d')."-".date('m')."-".date('Y'); ?>"/><img title="Klik untuk membuka kalender !" src="../../images/ico/calendar_1.png" name="btntanggal" width="16" height="16" border="0" id="btntanggal"/>
    </td>
  </tr>
    <tr>
    ...
    <td colspan="2">
    	<div style="vertical-align:middle">
    	  <input type="radio" value="2" checked="checked" name="jenisberita" id="jenisberita" />&nbsp;<strong>Umum&nbsp;&nbsp;&nbsp;&nbsp;
          <input type="radio" value="1" name="jenisberita" id="jenisberita" />
&nbsp;Darurat&nbsp;</strong>&nbsp; &nbsp;&nbsp; [ <span class="style1"><em>Dipilih sesuai kondisi yang terjadi</em></span> ]         </div>
    </td>
  </tr>
  <tr>
