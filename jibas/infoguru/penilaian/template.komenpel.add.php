...
require_once('template.komenpel.add.func.php');
...
<head>
    ...
    <title>JIBAS SIMAKA [Tambah Template Komentar Pelajaran]</title>
    ...
    <tr height="58">
        ...
        <td width="*" background="../<?=GetThemeDir() ?>bgpop_02a.jpg">
            <div align="left" style="color:#FFFFFF; font-size:12px; font-weight:bold">
                Tambah Template Komentar Pelajaran
            </div>
        </td>
    ...
    <tr height="150">
        ...
        <td width="0" style="background-color:#FFFFFF">
            ...
            <form name="main" onSubmit="return validate()">
                ...
                <input type='hidden' id='kdaspek' name='kdaspek' value='<?=$kdaspek?>'>
