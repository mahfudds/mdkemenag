...
<table width="100%" border="0" cellspacing="0">
  ...
  OpenDb();
	...
	$sql1="SELECT pg.idguru as idguru,pg.nis as nis,t.replid as replid, pg.replid as replid2, pg.judul as judul, DATE_FORMAT(pg.tanggalpesan, '%e %b %Y') as tanggal, TIME_FORMAT(pg.tanggalpesan, '%H:%i') as waktu, t.baru as baru FROM jbsvcr.pesan pg, jbsvcr.tujuanpesan t WHERE t.idpesan=pg.replid AND t.idpenerima='".SI_USER_ID()."' AND t.aktif=1 ORDER BY pg.tanggalpesan DESC, pg.replid DESC LIMIT ".(int)$page*(int)$varbaris.",$varbaris";
