...
function errorHandler ($errno, $errstr, $errfile, $errline, $errcontext) 
{
   switch ($errno) 
   {
      ...
      case E_COMPILE_ERROR:
		 ...
		 /*
		 echo getcwd();
		 echo "<br>1 = " . file_exists("displayerror.php");
		 echo "<br>2 = " . file_exists("include/displayerror.php");
		 echo "<br>3 = " . file_exists("../include/displayerror.php");
		 echo "<br>4 = " . file_exists("../../include/displayerror.php");
		 exit();
		 */
