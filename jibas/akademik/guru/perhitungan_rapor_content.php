...
function tambah(tingkat) {
	...
	var nip = document.getElementById('nip_guru').value;
	newWindow('perhitungan_rapor_add.php?id_tingkat='+tingkat+'&id_pelajaran='+id+'&nip_guru='+nip, 'TambahAturanPerhitunganNilaiRapor','360','600','resizable=1,scrollbars=1,status=0,toolbar=0')
}

function edit(tingkat,aspek) {
	var id = document.getElementById('id_pelajaran').value;
	var nip = document.getElementById('nip_guru').value;
	newWindow('perhitungan_rapor_edit.php?id_tingkat='+tingkat+'&id_pelajaran='+id+'&nip_guru='+nip+"&aspek="+aspek, 'UbahAturanPerhitunganNilaiRapor','360','600','resizable=1,scrollbars=1,status=0,toolbar=0')
}
