...
<script language="JavaScript">
	...
	function caripegawai() {
		newWindow('../library/caripegawai.php?flag=0','CariPegawai','620','565','resizable=1,scrollbars=1,status=0,toolbar=0');
	}
...
?>
    ...
    <table border="1" class="tab" align="center">
        <tr>
            <td height="25" colspan="2" class="header"><div align="center">Input User Baru</div></td>
        </tr>
        <tr>
        ...
        <tr>
            <td>Password</td>
            <td class="td"><input type="password" size="50" name="password" <?=$dis ?> id="password"></td>
        </tr>
        <tr>
            <td>Konfirmasi</td>
            <td class="td"><input type="password" size="50" name="konfirmasi" <?=$dis ?> id="konfirmasi"></td>
        </tr>
        <tr>
            <td>Keterangan</td>
            <td class="td"><textarea wrap="soft" name="keterangan" cols="47" rows="3"
