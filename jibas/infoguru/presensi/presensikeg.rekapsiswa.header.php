...
<script src="presensikeg.rekapsiswa.header.js"></script>
...
<?      for($i = $G_START_YEAR; $i <= date('Y'); $i++)
    ...
    <td align='right' valign='top'>
        ...
        <font size="4" face="Verdana, Arial, Helvetica, sans-serif" color="Gray">Rekapitulasi Presensi Kegiatan Siswa</font><br />
        <a href="../presensi.php?page=pk" target="framecenter">
        <font size="1" color="#000000"><b>Presensi</b></font></a>&nbsp>&nbsp
        <font size="1" color="#000000"><b>Rekapitulasi Presensi Kegiatan Siswa</b></font>
    </td>
</tr>
</table>
</body>
