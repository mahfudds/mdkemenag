...
<title>JIBAS KEU [Ganti Password <?=$title?>]</title>
...
<body onLoad="document.getElementById('passlama').focus();" style="background-color:#dfdec9; margin-left:0px; margin-top:0px; margin-bottom:0px; margin-right:0px;">
...
<tr height="150">
    ...
    <tr>
        ...
        <td align="left">
        <? if ($login!='landlord' && $login!='LANDLORD'){ ?>
            	<input type="text" name="nip" id="nip" size="10" readonly="readonly" value="<?=$nip ?>"style="background-color:#CCCC99" />
        <? } ?>
        <input type="text" name="nama" id="nama" size="30" readonly="readonly" value="<?=$nama ?>" style="background-color:#CCCC99" /> 
        </td>
    </tr>
    <tr>
