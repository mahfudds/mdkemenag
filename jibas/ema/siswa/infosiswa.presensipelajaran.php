...
<br />
<form name="panelpp" id="panelpp" method="post">
...
<? 			}
        ...
        <td align="right" width="12%">
  			<a href="javascript:CetakPresensiPelajaran2()" ><img src="../img/print.png" width="16" height="16" border="0" />&nbsp;Cetak</a>
    	</td>
  	</tr>
<? if ($kelas<> "" ) { 
		...
		$sql1 = "SELECT CONCAT(DATE_FORMAT(tanggal,'%b'),' ',YEAR(tanggal)) AS blnthn,
						SUM(IF(statushadir = 0,1,0)), SUM(IF(statushadir = 1,1,0)), SUM(IF(statushadir = 2,1,0)),
						SUM(IF(statushadir = 4,1,0)), SUM(IF(statushadir = 3,1,0)), MONTH(tanggal)
...
?>
        ...
        <tr>
        	<td>
            <table class="tab" id="table" border="1" cellpadding="0" style="border-collapse:collapse" cellspacing="0" width="100%" align="center" bordercolor="#000000">		
