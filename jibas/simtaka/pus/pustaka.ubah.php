...
require_once('pustaka.ubah.class.php');
OpenDb();
$P = new CPustaka();
$P->OnStart();
?>
...
<script type="text/javascript" src="pustaka.ubah.js"></script>
...
<body>
	...
	<div id="title" align="right">
        ...
        <font style="font-size:18px; color:#999999">Ubah Pustaka</font><br />
        <a href="pustaka.php" class="welc">Pustaka</a><span class="welc"> > Ubah Pustaka</span><br /><br /><br />
    </div>
    <div id="content">
      <?=$P->Content()?>
    </div>
