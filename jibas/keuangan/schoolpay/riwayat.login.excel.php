...
header('Content-Disposition: attachment; filename=Riwayat_Login.xls');
header('Expires: 0');
...
?>
    ...
    <head>
        ...
        <title>JIBAS KEU [Riwayat Login SchoolPay POS Android]</title>
    </head>

    <body>
    <center><font size="4"><strong>RIWAYAT LOGIN SCHOOLPAY POS ANDROID</strong></font><br /> </center><br /><br />`
    <table border="0">
    <tr>
