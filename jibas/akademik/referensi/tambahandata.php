...
function tambah() {
    ...
    newWindow('tambahandata.add.php?departemen='+departemen, 'TambahTambahanData','530','350','resizable=1,scrollbars=1,status=0,toolbar=0')
}

function refresh() {
    var departemen = document.getElementById('departemen').value;
    document.location.href = "tambahandata.php?departemen="+departemen;
}

function edit(replid) {
    var departemen = document.getElementById('departemen').value;
    newWindow('tambahandata.edit.php?replid='+replid+'&departemen='+departemen, 'UbahTambahanData','530','350','resizable=1,scrollbars=1,status=0,toolbar=0')
}

function hapus(replid) {
    var departemen = document.getElementById('departemen').value;
    if (confirm("Apakah anda yakin akan menghapus tambahan data ini?"))
        document.location.href = "tambahandata.php?op=xm8r389xemx23xb2378e23&replid="+replid+"&departemen="+departemen;
}
...
function setaktif(replid, aktif)
{
    ...
    var departemen = document.getElementById('departemen').value;
    if (confirm(msg))
        document.location.href = "tambahandata.php?op=dw8dxn8w9ms8zs22&replid="+replid+"&newaktif="+newaktif+"&departemen="+departemen;
}

function cetak() {
    var departemen = document.getElementById('departemen').value;
    newWindow('tambahandata.cetak.php?departemen='+departemen, 'CetakTambahanData','790','650','resizable=1,scrollbars=1,status=0,toolbar=0')
}
...
<tr height="300">
    ...
    <tr>
        <td align="right">
            ...
            <font size="4" face="Verdana, Arial, Helvetica, sans-serif" color="Gray"><?=$title?></font>
        </td>
    </tr>
    <tr>
        <td align="right">
            <a href="<?=$backurl?>" target="content">
            <font size="1" face="Verdana" color="#000000"><b><?=$from?></b></font>
            </a>
            &nbsp>&nbsp
            <font size="1" face="Verdana" color="#000000"><b><?=$title?></b></font>
        </td>
    </tr>
    </table>
    <br /><br />
