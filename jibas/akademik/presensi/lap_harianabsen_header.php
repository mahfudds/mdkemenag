...
function tampil() {
	...
	if (validasi)		
		parent.footer.location.href = "lap_harianabsen_footer.php?tahunajaran="+tahunajaran+"&tgl1="+tgl1+"&bln1="+bln1+"&th1="+th1+"&tgl2="+tgl2+"&bln2="+bln2+"&th2="+th2+"&semester="+semester+"&kelas="+kelas+"&tingkat="+tingkat+"&departemen="+departemen;
}
