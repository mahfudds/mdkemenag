...
<?		$cnt = 0;
		for($i = 0; $i < $n; $i++)
		{
			...
			echo  "<td align='right' valign='top'>" . $subtotal . "</td>";
			echo  "</tr>";
		} 
		...
		for($i = 0; $i < $m; $i++)
		{
			...
			echo  "<td align='right' align='right' valign='middle' bgcolor='#333333'><font color='#ffffff'><strong>" . $subtotal . "</strong></font></td>";
		}
		echo  "<td align='right' valign='middle' bgcolor='#333333'><font color='#ffffff'><strong>" . $total . "</strong></font></td>";
		echo  "</tr>";
