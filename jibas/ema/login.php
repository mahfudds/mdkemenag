...
<title>JIBAS Executive Summary Report (EMA)</title>
        ...
        <table id="Table_01" width="510" height="206" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td style="padding-right:4px"><input type="text" name="username" id="username" class="InputTxt" onfocus="InputHover('Username','username','1')" onblur="InputHover('Username','username','0')" style="color:#636363;width:80px; border:1px #666666 solid; font-size:11px" value="Username"  /></td>
