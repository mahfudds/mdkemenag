...
<br>
<span style="font-size: 14px; font-weight: bold; font-family: Verdana">Keterangan</span>
<br><br>
...
<tr>
    ...
    <td width="500" align="left">
        <input type="text" id="urutan" name="urutan" style="font-size: 12px; height: 25px; width: 50px;" maxlength="3">
    </td>
</tr>
<tr>
    <td width="100" align="right" valign="top">Keterangan:</td>
    <td width="500" align="left">
        <textarea id="keterangan" name="keterangan" rows="5" cols="60" style="font-size: 12px;"></textarea>
    </td>
</tr>
<tr>
    <td width="100" align="right" valign="top">&nbsp;</td>
    <td width="500" align="left">
        <input type="button" id="Simpan" name="Simpan" value="Simpan" class="but" style="height: 25px;" onclick="simpanMedia()">
