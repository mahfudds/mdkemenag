...
$sql = "SELECT p.replid, DATE_FORMAT(date_in, '%d %b %Y') AS date_in, time_in, DATE_FORMAT(date_out, '%d %b %Y') AS date_out, 
               ...
               WEEKDAY(date_in) AS weekday, IF(p.info1 IS NULL, 0, p.info1) AS telat, IF(p.nip IS NULL, 0, 1) AS ownertype,
...
<tr>
    <td align="right">
        <a href="#" onClick="document.location.reload()">
            <img src="../img/ico/refresh.png" border="0"/>&nbsp;Refresh
        </a>&nbsp;&nbsp;
        <a href="#" onclick="excel()">
            <img src="../img/ico/excel.png" border="0" />&nbsp;Excel
        </a>&nbsp;&nbsp;
        <a href="#" onclick="cetak()">
            <img src="../img/ico/print.png" height='16' border="0" />&nbsp;Cetak
        </a>
    </td>
</tr>    
</table>
...
while($row = mysql_fetch_array($res))
{
    ...
    <tr height='25'>
        ...
        <td align='left'><?=DateArith::ToStringHourFromMinute($row['telat'])?></td>
