...
{
	$rel = "./";
	if (file_exists("../sty/style-default.css"))
		$rel = "../";
	elseif (file_exists("../../sty/style-default.css"))
		$rel = "../../";
	
	date_default_timezone_set('Asia/Jakarta');
	
	$html1  = "<html><head><link rel='stylesheet' type='text/css' href='". $rel ."sty/style-default.css'></head><body>";
	...
	$html1 .= "<input type='hidden' name='appmodule' value='perpustakaan'>\r\n";
	...
	$html2  = "</td></tr><tr><td><img src='". $rel ."img/bk_message_03.jpg' width='457' height='18'></td></tr></table>";
