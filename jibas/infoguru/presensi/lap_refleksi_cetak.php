...
$sql = "SELECT t.departemen, a.tahunajaran, s.semester, k.kelas, t.tingkat, l.nama 
         ...
         WHERE p.idkelas = k.replid AND k.idtingkat = t.replid AND k.idtahunajaran = a.replid 
           AND p.idsemester = s.replid AND a.aktif = 1 AND s.replid = '$semester' AND p.idpelajaran = l.replid  $filter1 $filter2 $filter3";
$result = QueryDB($sql);
