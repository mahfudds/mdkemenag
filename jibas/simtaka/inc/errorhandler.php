...
function errorHandler ($errno, $errstr, $errfile, $errline, $errcontext) 
{
   switch ($errno) 
   {
      ...
      case E_COMPILE_ERROR:
		 ...
		 elseif (file_exists("inc/displayerror.php"))
   		 {
			 echo  "<script language='javascript'>";
			 echo  "if (self == top || parent == top)";
			 echo  "    document.location.href = 'inc/displayerror.php?$r';";
			 echo  "else if (parent.parent != top)";
			 echo  "    parent.parent.location.href = 'inc/displayerror.php?$r';";
			 echo  "else ";
			 echo  "    parent.location.href = 'inc/displayerror.php?$r';";
			 echo  "</script>";
		 }
		 elseif (file_exists("../inc/displayerror.php"))
		 {
