 ...
 **[N]**/ ?>
<?php
require_once("ujianumumsiswa.func.php");
...
else if ($op == "getpilihantingkat")
{
    $dept = $_REQUEST["dept"];
    $idPelajaran = $_REQUEST["idpelajaran"];

    echo getPilihanTingkat($dept, $idPelajaran);
}
else if ($op == "getpilihansemester")
{
    $dept = $_REQUEST["dept"];
    $idPelajaran = $_REQUEST["idpelajaran"];

    echo getPilihanSemester($dept, $idPelajaran);
}
else if ($op == "getdaftarujian")
{
    ...
    echo getDaftarUjian($dept, $viewDaftarUjian, $idPelajaran, $idTingkat, $idSemester);
}
