...
header('Content-Disposition: attachment; filename=Stat_Trans.xls');
header('Expires: 0');
...
?>
    ...
    <head>
        ...
        <title>JIBAS KEU [Statistik Transaksi]</title>
    </head>

    <body>
    <center><font size="4"><strong>STATISTIK TRANSAKSI VENDOR</strong></font><br /> </center><br /><br />`
    <table border="0">
        <tr>
