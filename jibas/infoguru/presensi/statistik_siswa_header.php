...
<tr>	
	...
	<td align="left" valign="middle"><a href="#" onclick="tampil()" ><img src="../images/ico/view.png"  onmouseover="showhint('Klik untuk menampilkan statistik kehadiran setiap siswa!', this, event, '100px')" height="48" border="0" name="tabel" id="tabel"/></a></td>
