...
require_once('presensi.list.class.php');
OpenDb();
//$PL = new PresensiList();
//$P->OnStart();
?>
...
<title>Presensi List</title>
<link rel="stylesheet" type="text/css" href="../style/style.css" />
<script language="javascript" src="../script/ShowError.js"></script>
<script language="javascript" src="../script/ajax.js"></script>
<script language="javascript" src="../script/tables.js"></script>
<script language="javascript" src="presensi.list.js"></script>
<script src="../SpryAssets/SpryTabbedPanels.js" type="text/javascript"></script>
<link href="../SpryAssets/SpryTabbedPanels.css" rel="stylesheet" type="text/css" />
</head>
<body onresize="resize()" onload="resize()">
<div id="SubTitle" align="right">
<span style="color:#F90; background-color:#F90; font-size:20px">&nbsp;</span>&nbsp;<span style="color:#060; font-size:16px; font-weight:bold">Daftar Presensi</span><br />
<a href="presensi.main.php">Presensi</a> > Daftar Laporan Presensi
</div>
<table width="100%" border="0" cellspacing="3" cellpadding="3">
  <tr>
    ...
    <td valign="top">
    <div id="DetailInfoGenList" style="overflow:auto; padding-left:2px; width:100%; overflow-x:hidden">
