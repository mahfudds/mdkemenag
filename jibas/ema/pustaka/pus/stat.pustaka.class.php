...
<?							echo "<select name='ThnAkhir' id='ThnAkhir' class='cmbfrm' onchange='chg()'>";
            ...
            <div id="title" align="right">
        		...
        		<span class="news_title2">Statistik Pustaka Favorit</span>
            </div>
            </td>
        </tr>
        <tr>
...
<? 		if (@mysql_num_rows($result) > 0)
        ...
        <tr>
		    <td colspan="2" align="center" valign="top">
				<a href="javascript:Cetak()"><img src="../../img/ico/print1.png" width="16" height="16" border="0" />&nbsp;Cetak</a>
			</td>
	    </tr>
        <tr>
...
<? 					} ?>
				...
				<td valign="top">
                   	<div id="ListInfo" style="padding-left:15px">
                    </div>
                </td>
			</tr>
			</table>
