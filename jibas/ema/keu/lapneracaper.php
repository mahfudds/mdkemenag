...
function change_sel() {
	//parent.content.location.href = "lapneracaper_blank.php";
}
...
function change_dep() {
	...
	//parent.content.location.href = "lapneracaper_blank.php";
	var addr = "lapneracaper.php?idtahunbuku="+idtahunbuku+"&tgl1="+tgl1+"&bln1="+bln1+"&thn1="+thn1+"&tgl2="+tgl2+"&bln2="+bln2+"&thn2="+thn2+"&departemen="+dep;
...
function show_laporan() {
	...
	if (validasi)
		sendRequestText('get_lapneracaper.php',showLap,'departemen='+dep+'&tanggal1='+tanggal1+'&tanggal2='+tanggal2+'&idtahunbuku='+idtahunbuku);	
		//parent.content.location.href ="lapneracaper_content.php?departemen="+dep+"&tanggal1="+tanggal1+"&tanggal2="+tanggal2+"&idtahunbuku="+idtahunbuku;
}
function cetak(){
	var dep = document.getElementById('departemen').value;
	var tgl1 = parseInt(document.getElementById('tgl1').value);
	...
	var tanggal1 = escape(thn1 + "-" + bln1 + "-" + tgl1);
	var tanggal2 = escape(thn2 + "-" + bln2 + "-" + tgl2);
	var addr = 'lapneracaper_cetak.php?departemen='+dep+'&tanggal1='+tanggal1+'&tanggal2='+tanggal2+'&idtahunbuku='+idtahunbuku+'&bln='+bln2+'&thn='+thn2;
	newWindow(addr, 'CetakNeracaPercobaan','790','630','resizable=1,scrollbars=1,status=0,toolbar=0');
}
function showLap(x){
...
<?		if ($tgl1 == 0)	$tgl1 = $tgl2;
  	...
  	<td rowspan="2" valign = "middle">
        <a href="#" onclick="show_laporan()"><img src="../img/view.png" border="0" height="48" width="48" id="tabel" onmouseover="showhint('Klik untuk menampilkan data laporan neraca percobaan!', this, event, '180px')" /></a>    </td>
    <td width="40%" align="right" valign="top">
        <font size="4" face="Verdana, Arial, Helvetica, sans-serif" style="background-color:#ffcc66">&nbsp;</font>&nbsp;<span class="news_title2">Laporan Neraca Percobaan</span>
    </td>
</tr>
</table>
</form>
