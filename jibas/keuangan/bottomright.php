...
<tr height="25">
    <td width="20" background="<?=GetThemeDir() ?>bgmain_19.jpg">&nbsp;</td>
    <td width="26" background="<?=GetThemeDir() ?>bgmain_08a.jpg">&nbsp;</td>
</tr>
<tr height="42">
	<td width="20" background="<?=GetThemeDir() ?>bgmain_22a.jpg">&nbsp;</td>
    <td width="26" background="<?=GetThemeDir() ?>bgmain_23.jpg">&nbsp;</td>
</tr>
</table>
</body>
</html>