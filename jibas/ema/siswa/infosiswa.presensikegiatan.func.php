...
while($row = mysql_fetch_row($res))
{
    ...
    echo "<tr height='25'>\r\n";
    echo "<td align='center' rowspan='2'>$cnt</td>\r\n";
    ...
    echo "<tr>\r\n";
    echo "<td colspan='7'>\r\n";
    echo "<div id='pk_divDetail_$cnt'>\r\n";
    echo "<a href='#' onclick='pk_showDetail($cnt, $idkegiatan)' style='color: blue; font-weight: normal;'>detail</a>";
    echo "</div>\r\n";
    echo "</td>\r\n";
    echo "</tr>\r\n";
}
