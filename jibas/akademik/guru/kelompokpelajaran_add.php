...
<head>
    ...
    <title>JIBAS SIMAKA [Tambah Kelompok Pelajaran]</title>
    ...
    <script language="javascript">
        ...
        function panggil(elem){
            var lain = new Array('kode','nama','urutan');
            ...
            <form name="main" onSubmit="return validate()">
                <table border="0" width="95%" cellpadding="2" cellspacing="2" align="center">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="nama" id="nama" size="50" maxlength="50" value="<?=$nama?>" onFocus="showhint('Nama kelompok pelajaran tidak boleh lebih dari 50 karakter!', this, event, '120px'); panggil('nama')" onKeyPress="return focusNext('urutan', event)"/></td>
                    </tr>
                    <tr>
